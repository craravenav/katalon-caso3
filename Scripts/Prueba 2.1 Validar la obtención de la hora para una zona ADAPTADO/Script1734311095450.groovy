...
assert jsonResponse.timestamp != null : "El campo DATETIME no está presente"
assert jsonResponse.zoneName != null : "El campo TIMEZONE no está presente"
assert jsonResponse.gmtOffset != null : "El campo UTC_OFFSET no está presente"

// Valido que el campo 'timezone' sea igual a 'America/Santiago'
assert jsonResponse.zoneName == "America/Santiago" : "El timezone es incorrecto: ${jsonResponse.timezone}"
